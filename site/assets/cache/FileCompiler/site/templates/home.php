...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="<?php echo $config->urls->templates?>styles->vendor/bootstrap/css/bootstrap.min.css>" rel="stylesheet">
  ...
  <link href="<?php echo $config->urls->templates?>styles/css/one-page-wonder.min.css>" rel="stylesheet">
