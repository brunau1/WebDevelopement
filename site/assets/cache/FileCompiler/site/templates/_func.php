...
function renderSiteMap(\ProcessWire\PageArray $items, $maxDepth, $condition) {
...
function renderChild(\ProcessWire\PageArray $items, $page){
...
* Given a group of pages, render a simple <ul> navigation
	...
	*
	*/
	function renderNav(\ProcessWire\PageArray $items) {
